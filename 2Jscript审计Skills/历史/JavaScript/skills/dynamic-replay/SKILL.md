...
CLI：`python3 scripts/js_browser_lazyload_replay_plan.py --url <url> --out <report-dir> && python3 scripts/js_playwright_safe_replay_executor.py --plan <plan> --generate-spec --out <report-dir>`
