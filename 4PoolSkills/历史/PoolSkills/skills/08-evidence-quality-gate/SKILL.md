...
description: 证据 manifest、三次复现、负样本对照、误报排除、评分、准入门槛
---

# 08-evidence-quality-gate

证据 manifest、三次复现、负样本对照、误报排除、评分、准入门槛

## 原始来源映射

本 skill 合并/承接 31 个原始 `SKILL.md` 的相关能力。代表来源：
...
- `trailofbits-skills/skills-c94841be3deae8a880fa1a9078979adac7ca3dbc/plugins/fp-check/skills/fp-check/SKILL.md`
...
- `trailofbits-skills/skills-c94841be3deae8a880fa1a9078979adac7ca3dbc/plugins/static-analysis/skills/sarif-parsing/SKILL.md`
...
- `transilienceai-communitytools/communitytools-0f06ed314493e7f3b1da30de4d5ad0d4cb85d5bf/skills/cve-risk-score/SKILL.md`
- `transilienceai-communitytools/communitytools-0f06ed314493e7f3b1da30de4d5ad0d4cb85d5bf/skills/dfir/SKILL.md`
...
- `transilienceai-communitytools/communitytools-0f06ed314493e7f3b1da30de4d5ad0d4cb85d5bf/skills/risk-prioritiser/SKILL.md`
...
任何候选漏洞、报告前置审查、误报排除、证据缺口分析、复现稳定性检查时触发。

## 执行步骤

1. 用 `EVIDENCE_MANIFEST_SCHEMA.json` 校验证据字段。
2. 调用 `scripts/quality_gate_score.py` 打分。
3. 检查代码证据、动态证据、影响证据、负样本、复现次数、非破坏性边界。
4. 输出 `quality_results.json`；低于门槛不交给 09。
