...
```bash
python3 scripts/code-surface-inventory.py <authorized_project_root> -o code-surface-inventory.jsonl
python3 scripts/js-asset-audit.py <authorized_project_root> -o js-asset-candidates.jsonl
python3 scripts/parser-backend-check.py --out parser-backend-check.json
```
...
```bash
python3 scripts/config-dependency-inventory.py <authorized_project_root> -o config-dependency-inventory.jsonl
python3 scripts/js-manifest-expander.py <authorized_project_root> -o js-manifest-assets.jsonl
python3 scripts/info-surface-normalizer.py \
...
python3 scripts/codegraph-builder.py <project-root> -o out/codegraph.json
python3 scripts/source-sink-dataflow.py <project-root> -o out/source-sink.jsonl
python3 detectors/c01_c05_access_control.py --input out/info-surface.normalized.jsonl -o out/c01-c05.jsonl
```
...
```bash
python3 scripts/hidden-info-miner.py <project-root> -o hidden-info-candidates.jsonl
python3 scripts/api-spec-inventory.py <project-root> -o api-spec-candidates.jsonl
python3 scripts/surface-coverage-audit.py --root . --jsonl hidden-info-candidates.jsonl --jsonl api-spec-candidates.jsonl --out info-coverage-audit.json
```
