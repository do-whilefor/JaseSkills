...
RULES = [
    {"type":"hidden_api_parameter_browser_replay","words":["隐藏接口","隐藏参数","前端不接受","后端接受","backend accepted","extra params","Mass Assignment","Over-posting","懒加载","真实浏览器","点击","滚动","hover","多角色","多租户","GraphQL 隐藏字段","WebSocket 隐藏 action"],"chain":["00","01","15","16","17","18","19","08","20","10"],"forbidden":["把 JS 字符串候选写成后端已接受","未跑浏览器却写懒加载已覆盖","无 role/tenant replay 写 verified","无请求响应差异写漏洞成立"]},
