...
SCHEMAS={
  ...
  'information-finding': ROOT/'schemas'/'information-finding.schema.json',
  'endpoint': ROOT/'schemas'/'endpoint.schema.json',
  'parameter': ROOT/'schemas'/'parameter.schema.json',
